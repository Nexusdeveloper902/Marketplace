...
function legalMarkup(doc) {
  ...
  <article class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
    <a href="${hrefFromApp("/")}" class="group mb-10 inline-flex items-center gap-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
...
function iniciar() {
  const slug = currentAppRoute().replace("/", "")
