  ...
  <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
    <div class="reveal is-visible text-center">
      ...
      <div class="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
        <a href="${hrefFromApp("/garaje")}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 sm:w-auto">
          Ver mi garaje ${icon("ArrowRight", "h-4 w-4")}
        </a>
        <a href="${hrefFromApp("/marketplace")}" class="inline-flex w-full items-center justify-center rounded-xl border border-border bg-card px-7 py-3.5 text-sm font-semibold text-foreground transition-colors hover:bg-accent sm:w-auto">
          Seguir explorando
        </a>
      </div>
    </div>
