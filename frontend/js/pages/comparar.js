            ...
            ${items.map((v) => `
              <td class="p-3 align-bottom" data-slug="${escapeHtml(v.id)}" style="width: ${100 / cols}%">
                <div class="relative rounded-xl border border-border/50 bg-secondary/40 p-3">
                  ...
                  <a href="${hrefFromApp("/vehiculos/" + (v.id))}" class="block aspect-[16/9] overflow-hidden rounded-lg bg-secondary">
                  ...
                  <a href="${hrefFromApp("/vehiculos/" + (v.id))}" class="block text-sm font-semibold text-foreground hover:underline">${escapeHtml(v.modelo)}</a>
