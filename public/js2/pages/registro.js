  ...
  <div class="min-h-screen bg-background">
    <div class="grid min-h-screen lg:grid-cols-2">
      <div class="relative hidden overflow-hidden lg:block">
        <img src="/vehicles/ferrari-sf90-stradale/1.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" />
      ...
      <div class="flex min-h-screen items-center justify-center px-4 py-16 sm:px-6">
        <form id="registro-form" class="reveal is-visible w-full max-w-md" novalidate>
          <a href="/" class="mb-8 flex items-center gap-2.5" aria-label="Ir al inicio">
          ...
          <div class="mt-8 space-y-5">
            ...
            <p class="text-center text-sm text-muted-foreground">
              ¿Ya tienes cuenta? <a href="/login${redirect !== "/" ? `?redirect=${encodeURIComponent(redirect)}` : ""}" class="font-medium text-[var(--signature)] hover:underline">Iniciar sesión</a>
            </p>
          </div>
        </form>
      </div>
